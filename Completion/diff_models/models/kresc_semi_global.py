...
@MODEL_REGISTRY
class KResCSemiGlobal(KiloBase):
    """
    ...
    def __init__(self, decoder: nn.Module, full_global_pointnet: nn.Module, partial_global_pointnet: nn.Module,
        global_vae_encoder: nn.Module, global_prior_encoder: nn.Module,
        with_proj=True, res_after_type=None,
    ...
    def decode(self, p, z, c=None, **kwargs):
        ...
        logits = self.decoder(p, z['zc'], **kwargs)
        return logits
    ...
    def step(self, batch, batch_idx):
        ...
        zc = torch.cat([z, c_global], dim=1)
        pred_occ = self.decode(query_pts, z={'zc': zc}, c=c_global) 
