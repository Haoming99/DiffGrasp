...
# @MODEL_REGISTRY
class Diffusion3XMono(KiloBase):
    """
    Diffusion3X Mono that takes both partial and complete point cloud as input and attempt
    to have a skip connection on partial stream to improve fidelity.
    Features will be append with _c for attention decoder
    ...
    def encode_inputs(self, partial_pcs, full_pcs=None):
        ...
        # Add conditional signal for Attn Conv Decoder
