...
class KRLocalDual(KiloBase):
    ...
    def __init__(self, decoder: nn.Module, global_pointnet: nn.Module, local_pointnet: nn.Module,
        ...
        full_factor_layer: nn.Module, partial_factor_layer: nn.Module,
        ...
        self.full_factor_layer = full_factor_layer
        self.partial_factor_layer = partial_factor_layer

        self.save_hyperparameters(ignore=["decoder", "unet3d", "global_vae_encoder", "global_prior_encoder",
          "full_global_pointnet", "partial_global_pointnet", "local_pointnet", "full_factor_layer", "partial_factor_layer"])
    ...
    def step(self, batch, batch_idx):
        ...
        layered_x = self.full_factor_layer(x_local)
        layered_c = self.partial_factor_layer(c_local)
