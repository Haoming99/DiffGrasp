...
def main():
    ...
    out_dir = f'/mnt/kostas-graid/datasets/FeatComp/paper_vis_neurips/{exp_name}/preview-test/'
    task_list = []

    for cat_id in cgan_all:
        os.makedirs(f"{out_dir}/{cat_id}", exist_ok=True)
        split_file = f'/mnt/kostas-graid/datasets/ShapeNetReduced/{cat_id}/cgan_val.lst'
