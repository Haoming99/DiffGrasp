...
os.makedirs('/tmp/gca_chamfer-build/', exist_ok=True)
cd = load(
    name="cd",
    sources=[
        "./libs/gca_chamfer/chamfer_distance.cpp",
        "./libs/gca_chamfer/chamfer_distance.cu"
    ],
    # build_directory='./libs/gca_chamfer/build/',
    build_directory='/tmp/gca_chamfer-build/',
    # verbose=True,
)
